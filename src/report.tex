...
representative model of the ITER device. The neutrons modelled in this 
analysis are the result of DT reactions in the plasma an no other neutrons
are considered. There are several ongoing questions
...
occur in a transport problem when a the time taken for any given history is 
...
particle is routletted into several low weight particles, and (typically but not
...
Table \ref{tab:cad_process} the origin of each file, the format it was recieved
...
The graveyard for the ITER SDDR model is a component that was created for the 
purpose of the neutronics analysis. It serves the function of reflecting or 
collecting particles that are streaming through or out of the geometry of 
interest. There is no origination information for this component because it was 
...
\begin{table}[ht!]
   \begin{tabular}{| l | c |}
      ...
      \cellcolor{blue!25} 400 Seconds & 500.0 & 1.980$\times$10$^19$ & \cellcolor{blue!25} 1.0  \\
      \cellcolor{blue!25} 3920 Seconds & 0.0 & 0.0 & \cellcolor{blue!25} 0.0 \\
      \cellcolor{green!25} 400 Seconds & 700.0 & 2.772$\times$10$^19$ &\cellcolor{green!25} 1.4 \\
      \cellcolor{green!25} 3920 Seconds & 0.0 & 0.0 &\cellcolor{green!25} 0.0 \\
      \hline
\end{tabular}
...
%% NOTE [PPHW]: What do we want to say here?
