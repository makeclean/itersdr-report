...
For the bioshield plug spectra we see shown in Figure \ref{bioshield_spectra_upp}, 
...
\ref{src_spectra_upp}, there are slight differences between the baseline and 
...
\ref{fig:src_spectra_pf2} to \ref{fig_src_spectra_upp}, the near the bioshield
...
of 0.25-0.35 difference between them, due to some statisical errors in the 
neutron transport. 
\\
\\
...
For the upper and equatoral port interspaces at each decay time the baseline case always has a greater area at higher 
dose rates than the B$_4$C case, the bottom contour of dose rate 1 mSv/hr in these plots, is consistenly pushed further
