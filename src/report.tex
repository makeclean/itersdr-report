...
of this scope, the uncertainty has been estimated as a factor of 2. That is, 
the actual results are expected to be between 0.5 times and 2 times the simulated results.
This estimate includes uncertainty in neutron transport, activation, photon transport and
those due to the resolution of the activation mesh. 
\\
\\
...
type and duration of maintenance that can be performed by personel access. Thus,
...
the in-wall plates, with all detail retained. within the vacuum vessel shells.
Also, overlaps were removed 
...
it is the B$_4$C layer is effective at absorbing thermalized neutrons in the \gls{epi} and \gls{upi}.
