...
equipment present in the port gls{pi} (both upper and lower), and the divertor
...
\gls{icrp}-74 dose response coefficients as a dose multiplier as recommended in
...
interspace is affected by the addition of boron carbide to the plasma side
surface of the bioshield. The reason for the this is significantly degraded
thermal flux which impacts the importance of (n,$\gamma$) reactions and also
...
steel components near to the bioshield, those components away from the
bioshield appear to have their activation dominated by the neutron transported
