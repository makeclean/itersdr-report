...
relased with the introduction of so much B$_4$C as shielding material, tritium
...
unmodified from how they were delived by US-ITER. Also, overlaps were removed 
...
\subsection{Baseline Neutron Flux Reults}
...
beyond the thermal shields are somewhat shielded by it. The \gls{bs} is als a
...
\item{Neutron transport uncertainty - the neutron transport calculation has instrinsic uncertainties
     in the calculation. These uncertainties are linked to how low the statiscal error is 
...
quantites are the source of active research at a number of institutions world
...
of the producion of the nuclide due to all the formation channels, this is nuclide dependent but typically in the range 10-100\%. 
...
Based on this information combined with expert judgement, the most optimisitic
