...
ways. The correct method to determine the uncertainty in the SDR has not been performed, however we attempt an
estimate below.
...
\end{enumerate}
The smallest the total relative error could be therefore in the range 0.7 to 1.45 and the highest reasonable 
estimate is 0.5 to 2.0.
