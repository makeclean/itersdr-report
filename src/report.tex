...
complimentary, and therefore to compare the difference between the two different cases the
...
\\
\\
Focus should be placed on methods to decrease the \gls{sdr} in the person 
