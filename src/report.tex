...
8 azimuthal angles, 8 polar angles with P$_3$ diffusion correction. The Denovo
solver used was gmres with the cesaro transport correction. 
...
smaller batching system calculations did finish, however, only 5\% of all
calculations for each mesh finished, but this represents $5\times10^7$ total
source histories for each mesh, or 10 successful sub runs for each mesh.
\\
\\
