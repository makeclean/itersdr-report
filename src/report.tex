...
\newacronym{alara_c}{ALARA}{Analytic and Laplacian Adaptive Radioactivity Analysis}
...
calculations result in mathematically perfect space and energy dependent biasing
...
\begin{centering}
 \begin{table}[ht!]
  ...
  \hline 
  DAG-MCNP5 & 1.0 & Production & \\
  ALARA & 2.9.1 & Production & \\
  ADVANTG & 3.0.2 & Production & \\
  Denovo & 5.3 & Production & \\
  yt & 3.2 & Production & \\
  \end{tabular}
 \caption{}
...
parameters were too extreme resulting in severe over splitting of particles.
...
perhaps solutions like that already underway at UW-Madison \& \gls{ornl};
GT-CADIS \& MS-CADIS respectively. The uncertainty due to the statistical error
is sufficiently low in most regions of the model that the neutron flux can be
said to be converged, however, there are regions where the statistical error
is large enough to cause under or overestimates of the total neutron flux.
\newpage
\clearpage
