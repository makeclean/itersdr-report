...
\begin{centering}
 \begin{longtable}[ht!]{ p{0.2\textwidth} | p{0.3\textwidth} | p{0.3\textwidth} }
  ...
  M102  & 316L(N)-IG &  CLITE V1 \\
  M103  & 316L(N)-IG &  CLITE V1 \\
  M104  & 316L(N)-IG &  CLITE V1 \\
  M105  & 316L(N)-IG &  CLITE V1 \\
  M106  & 316L(N)-IG &  CLITE V1 \\
  M107  & XM-19      &  CLITE V1 \\
  M108  & 316L(N)-IG &  CLITE V1 \\
  M109  & 316L(N)-IG &  CLITE V1 \\
  M110  & 316L(N)-IG &  CLITE V1 \\
  M111  & 316L(N)-IG &  CLITE V1 \\
  M162  & H$_2$0 + 316L(N)-IG + SS430 + XM19 &  CLITE V1 \\
  ...
  M603  & H$_2$O + 316L(N)-IG &  CLITE V1 \\
  M611  & H$_2$O + 316L(N)-IG &  CLITE V1 \\
  M613  & H$_2$O + 316L(N)-IG &  CLITE V1 \\
  ...
  M913 & 316L(N)-IG & CLITE V1\\
  M914 & 316L(N)-IG & CLITE V1\\
  M915 & Copy M910 & Bespoke \\
  M916 & 316L(N)-IG & CLITE V1\\
  M917 & Cryopipes & \cite{cryopump_communication}\\
  M918 & 316L(N)-IG & CLITE V1 \\
  M920 & 316L(N)-IG & CLITE V1 \\
  M921 & 316L(N)-IG & CLITE V1 \\
  M922 & 316L(N)-IG & CLITE V1 \\
  M923 & 316L(N)-IG & CLITE V1 \\
  M924 & 316L(N)-IG & CLITE V1 \\
  M925 & 316L(N)-IG & CLITE V1 \\
...
to represent a rectangular parallel pipe that extend from x=-1000 cm to x=1900
