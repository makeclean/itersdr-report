...
\begin{table}[ht!]
   ...
   \begin{tabular}{| c | c | c | c |}
      ...
      Decay Time (s) & Dose Rate & Dose Rate & Dose Rate \\
      \hline
      1.0$\times$10$^{5}$ & 2.426$\times$10$^{3}$ & 1.481$\times$10$^{3}$ & 1.133$\times$10$^{3}$ $\pm$ 6.3\%\\
      1.0$\times$10$^{6}$ & 1.936$\times$10$^{3}$ & 1.481$\times$10$^{3}$ & 2.628$\times$10$^{2}$ $\pm$ 11.0\%\\
      1.0$\times$10$^{7}$ & 6.750$\times$10$^{2}$ & 4.501$\times$10$^{2}$ & 2.806$\times$10$^{2}$ $\pm$ 11.7\%\\
      \hline
\end{tabular}
