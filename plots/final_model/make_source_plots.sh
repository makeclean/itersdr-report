...
echo '\caption{The shutdown photon source for the case with B$_4$C for decay time '$2' in the energy ranges '$ranges'}'
echo "\end{figure}"
echo "\clearpage"
}
...
echo '\caption{The total shutdown photon source for the case with B$_4$C for decay time '$2'}'
echo "\end{figure}"
echo "\clearpage"
}
